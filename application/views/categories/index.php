...
<tr class="hoverable">
	...
	<?php if ($this->session->userdata('user_id') == $category['pencil_db_categories_user_id'] || $this->session->userdata('is_admin') == 'yes'): ?>
		<form action="categories/delete/<?php echo $category['pencil_db_categories_id'] ?>" method="POST">
			<td><button type="submit" class="btn red"><i class="fas fa-trash"></i></button></td>
		</form>
	<?php endif;?>
</tr>
<?php endforeach;?>
