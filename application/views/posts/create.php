    ...
    <div class="row pr-5 pl-5">
      ...
      <div class=" col-lg-5">
      	<div id="create_post_form_title">
        	<h3 class="text-center animated bounceInDown mb-4 mt-5">Create!</h3>
    	</div>
        <!-- title -->
         <div class="form-group mb-4">
            <div class="input-group">
              <input type="text" name="post_title" value="" class="form-control" placeholder="Title" required autofocus>
            </div>
         </div>
    ...
    <div class="col-lg-7 mt-5">
      <div class="form-group d-flex justify-content-center">
        <div class="input-group animated flipInX">
          <textarea name="post_body" id="ckeditor_textarea" class="form-control" placeholder="Body" required></textarea>
        </div>
      </div>
    </div>
    </div>
	 ...
	 <div class="card-footer d-flex justify-content-center">
           <button type="submit" id="create_post_btn"  class="btn btn-primary shadow-lg" name="create_post_btn" style="width: 200px">Create</button>
       </div>
	<?php echo form_close(); ?>	
