		  ...
		  <div class="card">
		    ...
		    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#eula_accordian">
		      <div class="card-body container" style="font-size: 12px;padding-left: 7%;padding-right: 7%;">
				...
				pages from http://www.pencilblog.com for your own personal use subject to restrictions set in these terms and conditions.</p>
				<p>Redistribute content from Pencil (unless content is specifically made for redistribution).</p>
			<h2>User Comments</h2>
				<ol>
					<li>This Agreement shall begin on the date hereof.</li>
					<li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
					material and data ('Comments') in areas of the website. Pencil does not screen, edit, publish
					or review Comments prior to their appearance on the website and Comments do not reflect the views or
					opinions ofPencil, its agents or affiliates. Comments reflect the view and opinion of the
					person who posts such view or opinion. To the extent permitted by applicable laws Pencilshall
					...
					website.</li>
					<li>Pencilreserves the right to monitor all Comments and to remove any Comments which it considers
					...
					<li>You hereby grant to <strong>Pencil</strong> a non-exclusive royalty-free license to use, reproduce,
			...
			<h2>Hyperlinking to our Content</h2>
				...
				the visibility associated with the hyperlink outweighs the absence of Pencil and (d) where the
				...
				you must notify us by sending an e-mail to <a href="mailto:abhaykeerthy12@gmail.com" title="send an email to abhaykeerthy12@gmail.com">abhaykeerthy12@gmail.com</a>.
				...
				<p>No use of Pencil’s logo or other artwork will be allowed for linking absent a trademark license
				agreement.</p>
			<h2>Iframes</h2>
